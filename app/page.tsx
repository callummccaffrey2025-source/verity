...
import SafeLogos from "@/components/site/SafeLogos";
...
import TodayMovement from "../components/home/TodayMovement";
...
export default async function Home() {
    ...
    <main className="min-h-screen bg-black text-zinc-200">
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <section className="mt-6">
          <h1 className="text-balance text-5xl font-semibold tracking-tight text-emerald-300 md:text-6xl">
    Track bills. Know your MP. Get alerts.
  </h1>
  ...
  {/* Today’s movement (auto-hides if nothing) */}
  <TrendingToday className="mt-6" />
