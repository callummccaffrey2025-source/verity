export const metadata = {
  title: "Citizen Petition Engine — Verity",
  description: "Create and route petitions to representatives with verified signatures and delivery receipts.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Citizen Petition Engine</h1>
      <p className="mt-2 text-neutral-300">Create and route petitions to representatives with verified signatures and delivery receipts.</p>
