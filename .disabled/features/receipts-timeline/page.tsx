export const metadata = {
  title: "Receipts Timeline — Verity",
  description: "Chronological, sourced milestones for each bill and MP: votes, quotes, filings, and coverage.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Receipts Timeline</h1>
      <p className="mt-2 text-neutral-300">Chronological, sourced milestones for each bill and MP: votes, quotes, filings, and coverage.</p>
