export const metadata = {
  title: "MP Influence Score — Verity",
  description: "Transparent, multi-factor score from objective signals like bills progressed and engagement.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">MP Influence Score</h1>
      <p className="mt-2 text-neutral-300">Transparent, multi-factor score from objective signals like bills progressed and engagement.</p>
