export const metadata = {
  title: "Accountability Heatmaps — Verity",
  description: "Engagement and alignment visuals drawn from Hansard, division lists, and public records.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Accountability Heatmaps</h1>
      <p className="mt-2 text-neutral-300">Engagement and alignment visuals drawn from Hansard, division lists, and public records.</p>
