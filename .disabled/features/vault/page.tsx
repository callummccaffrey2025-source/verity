export const metadata = {
  title: "Verity Vault (Research Hub) — Verity",
  description: "Pro-grade dashboards, networks, and archives for journalists, analysts, and NGOs.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Verity Vault (Research Hub)</h1>
      <p className="mt-2 text-neutral-300">Pro-grade dashboards, networks, and archives for journalists, analysts, and NGOs.</p>
