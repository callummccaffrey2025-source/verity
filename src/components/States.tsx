export function EmptyState({title="Nothing here yet",hint="Try adjusting filters or check back soon."}){return(<div className="card p-6 text-center text-zinc-400">{title}<div className="text-xs mt-2">{hint}</div></div>);}
