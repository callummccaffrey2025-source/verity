export const metadata = {
  title: "Global Benchmarks — Verity",
  description: "Compare Australian policies to peer nations using reputable international datasets.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Global Benchmarks</h1>
      <p className="mt-2 text-neutral-300">Compare Australian policies to peer nations using reputable international datasets.</p>
