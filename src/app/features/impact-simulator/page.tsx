export const metadata = {
  title: "Legislation Impact Simulator — Verity",
  description: "Scenario-based, source-backed summaries of how proposed laws may affect different cohorts.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl p-8">
      <h1 className="text-3xl font-bold">Legislation Impact Simulator</h1>
      <p className="mt-2 text-neutral-300">Scenario-based, source-backed summaries of how proposed laws may affect different cohorts.</p>
