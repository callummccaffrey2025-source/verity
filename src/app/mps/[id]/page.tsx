        ...
        <section className="space-y-4">
          <article className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-zinc-300 md:grid-cols-4">
              <div>Attendance (12m) <span className="text-zinc-100 font-medium">{att12 == null || att12 === "" ? "—" : `${att12}%`}%`}</span></div>
              <div>Overall attendance <span className="text-zinc-100 font-medium">{attOverall == null || attOverall === "" ? "—" : `${attOverall}%`}%`}</span></div>
